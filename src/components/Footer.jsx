...
function Footer() {
  return (
    <div className='flex gap-5w-full h-screen bg-zinc-900 p-20 font-["Founders_Grotesk"]'>
        ...
        <div className="dets mt-20">
            <h1 className='S font-semibold uppercase mb-4'>S:</h1>
                <a className='block text-xl fontlight' href="#">Facebook</a>
                <a className='block text-xl fontlight' href="#">Instagram</a>
                <a className='block text-xl fontlight' href="#">Twitter</a>
                <a className='block text-xl fontlight' href="#">Linkedin</a>

        </div>

        <div className="dets mt-10">
            <h1 className='S font-semibold uppercase mb-4'>L:</h1>
                <a className='block text-xl fontlight' href="#">109-2023</a>
                <a className='block text-xl fontlight mb-3' href="#">Bhopal,MADHYA PRADESH</a>
                <a className='block text-xl fontlight' href="#">India</a>

        </div>

        <div className="dets mt-10">
            <h1 className='S font-semibold uppercase mb-4'>E:</h1>
                <a className='block text-xl fontlight' href="#">suhaniasawara@gmail.com</a>
